...
class Menu:
    def __init__(self, screen):
        ...
        self.btnLevel1 = Button(WIDTH // 2 - 150, HEIGHT // 4 * 2 + 20, 300, 100, screen, "Level 1",
    ...
    def draw_map(self, fileName):
        text_surface = my_font.render(
            'LEVEL {level} '.format(level=self.current_level, map=self.current_map + 1), False, WHITE)
    ...
    def run(self):
        ...
        return [self.current_level, self.map_name[0]]
